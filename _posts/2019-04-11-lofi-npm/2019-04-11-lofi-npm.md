...
- TODO <!-- --> tone.js demo page
- TODO <!-- --> tone.js finished project using websockets

{% include patreon-beg.html %} <style>#plug #patreon-beg { display:none }</style>
...
By Melody Starling [melody.dev](https://melody.dev).
...
I design and code websites, which I guess makes me a uniocnr!
...
You can probably (or imagine) hear the sounds of a laptop fans whizzing as accidentally leave too many tabs open.
...
Images: screenshots of the Activity Monitor app in macOS, showing tne CPU and Network tabs.

There are ways you can also digitally listen to your computer. Most operating systems comes with an interface for a task manager, which allows you to take a peek into what's going on in your computer.

### Slide 13

Image: screenshot of the Activity Monitor app in macOS, zoomed into a graph showing network data sent and recieved.

macOS's activity montitor even provides you with a graph. It honestly looks like something we can generate music from. (But that's another talk for another time!)
...
For those of you not aware, node.js is a runtime that allows your to run javascirpt outside of the browser, and npm is a package manager for node.js.

### Slide 15

Image: a file browser, showing a visually very large node_modules folder. folder.

If you have ever had the pleasure of dealing with npm before, you probably have encoutered a very large node_modules folder. And when I mean large, I mean large enough to take up 10% of my disk space!

### Slide 16

Video: a file browser, showing a visually very large node_modules folder, then zooming out to reval many visually small node_modules folders, then scrolled down to reveal over 1,000 more node_modules folders. [Link to video.](https://twitter.com/pixelyunicorn/status/1116445003138641926?s=20).
...
Why does this happen? Well, a project may have a couple of dependencies, but each of these individual dependencies may have a couple more dependencies, and so forth. It downloads everything recursvely! That gives us a treasure trove of activity we can monitor and generate music with!

### Slide 18

Let's see now installing a package with npm works.
...
[![node-red flow for outputting a command to a file](https://cdn.glitch.com/2d246102-8341-4166-a220-b39d607c9218%2Flofi-npm-node-red-output-to-file.png?1555692298120)](https://cdn.glitch.com/2d246102-8341-4166-a220-b39d607c9218%2Flofi-npm-node-red-output-to-file.png?1555692298120)
...
I also created a webpage to recieve these websocket output frames and match each of these keywords with a note!

<a href="https://cdn.glitch.com/2d246102-8341-4166-a220-b39d607c9218%2Flofi-npm-ws-light.png?1555692963439"><img src="https://cdn.glitch.com/2d246102-8341-4166-a220-b39d607c9218%2Flofi-npm-ws-light.png?1555692963439" class="visible-theme-light"/></a><a href="https://cdn.glitch.com/2d246102-8341-4166-a220-b39d607c9218%2Flofi-npm-ws-dark.png?1555692963439"><img src="https://cdn.glitch.com/2d246102-8341-4166-a220-b39d607c9218%2Flofi-npm-ws-dark.png?1555692963439" class="visible-theme-dark"/></a>
...
You could add a synthesizer. (But turns out generating 27,000 notes on the fly crashes my ancient Macbook!) 

You could implement bandwidth throttling.

If I had more time, I could show you how to add visualizations by hooking into tone.js.

### Slide 26

Image: screenshot of my website, showing colorful tiles arranged in an irregular grid layout.
